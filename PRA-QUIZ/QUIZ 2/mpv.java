...
public class mpv {
    ...
    public static class InvalidVideoFormatException extends Exception {
        public InvalidVideoFormatException(String msg){
            super(msg);
        }
    }
    ...
    public static class DuplicateVideoException extends Exception {
        public DuplicateVideoException(String msg){
            super(msg);
        }
    }
    public static class InvalidSubtitleException extends Exception {
        public InvalidSubtitleException(String msg){
            super(msg);
        }
    }
    public static class DuplicateSubtitleException extends Exception {
        public DuplicateSubtitleException(String msg){
            super(msg);
        }
    }
    // ================== MPV METHODS ==================
    ...
    public void addVideo(String title, String filename, int durationSeconds)
            throws InvalidVideoFormatException, DuplicateVideoException {
                ...
                if (!(filename.toLowerCase().endsWith(".mp4") || filename.toLowerCase().endsWith(".mkv") || filename.toLowerCase().endsWith(".avi")))
                ...
                Video v = new Video(nextVideoId++, title, filename, durationSeconds);
                videoDatabase.put(v.getId(), v);
    }
